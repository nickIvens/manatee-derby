 ...
 * @author Nick Ivens
 */
class ConfirmEnter extends Sprite
{
	...
	private function initGraphics():Void
	{
		...
		txt.y = 100;
		txt.width = 750;
		txt.text = "Are you sure you want to enter " + manatee.getName() + " in todays race for $100?\n if it comes first you win $500";
		addChild(txt);
	...
	{
		ranchState.enterSelection();
		ranchState.resetEnter();
